...
class BookLIstTableViewController: UITableViewController, AddBookDelegate {
    ...
    func getFilePath(whthFileName fileName:String) -> String {
    ...
    override func viewDidLoad() {
        ...
        let filePath = self.getFilePath(whthFileName: "obooks")
...
//                         price: 13000,
//                         desc: "오늘도 무사히 버텨낸 당신에게 전하는 응원의 메시지!",
...
//                         price: 16000,
//                         desc: "1986년 출간되어 1988년 고단샤 만화상을 수상한 후 30년 넘게 연재를 이어오고 있는 네 컷 만화 ‘보노보노’. 우리나라엔 1995년 만화책으로 처음 정식 소개되었다. 그 후 애니메이션과 영화로 각색되어 국내에도 두터운 팬층을 형성했다. 보노보노가 서른이 되어가는 동안 만화책과 애니메이션을 보고 자란 어린이들 역시 이제 어른이 되었다. 하지만 나이를 먹어도 여전히 사는 게 잘 모르겠고, 솔직해지려 하면 할수록 자신만 손해본다는 느낌에 스스로를 감추게 된다. 어른은 어른인데, 아직도 사는 데 소질 없는 ‘서툰 어른’이 된 것이다. ",
...
//                         price: 13800,
//                         desc: "어제 노트북을 켜고 ‘사람’을 입력하려다 실수로 ‘삶’을 쳤다. 그러고 보니 ‘사람’에서 슬며시 받침을 바꾸면 ‘사랑’이 되고 ‘사람’에서 은밀하게 모음을 빼면 ‘삶’이 된다. 세 단어가 닮아서일까. 사랑에 얽매이지 않고 살아가는 사람도, 사랑이 끼어들지 않는 삶도 없는 듯하다. ",
